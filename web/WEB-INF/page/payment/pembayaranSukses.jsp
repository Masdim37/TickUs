<%-- 
    ...
    Created on : Jun 10, 2025, 5:22:38 AM
    Author     : LENOVO
--%>
    ...
    <body>
        <div class="mobile-container">
            <jsp:include page="../user/navbar.jsp">
                <jsp:param name="page_title" value="Pembayaran Berhasil" />
            </jsp:include>
            <div class="main-content" style="padding-top: 70px;">
                <div class="status-page">
                    <div class="status-icon">
                        <img src="${pageContext.request.contextPath}/assets/images/Icon-Sukses.png" alt="Pembayaran Sukses">
                    </div>
                    <h2>PEMBAYARAN BERHASIL</h2>
                    <p>Untuk Mengecek Tiket Anda Silahkan Buka Menu Tiket Saya</p>
